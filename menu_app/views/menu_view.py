...
from menu_app.filters import MenuFilter
...
from customization_app.serializers import MenuCustomization, CustomizationSerializer
from customization_app.models import Customization

class MenuView(APIView,Validator):
    ...
    def post(self,request,kwargs):
        ...
        if menu_serializer.is_valid():
            ...
            json_response_obj['message'] = custom_messages.MENU_CREATED_SUCCESS_MSG
