...
class NearbyOfferRestaurantsView(APIView):
    ...
    def post(self,request):
        ...
        all_restaurants = Restaurant.objects.filter(id__in=RestaurantOffer.objects.select_related('res_id').values('res_id'),is_activated=True)
